  ...
  return (
    <div>
      ...
      <Container fluid style={{ backgroundColor: 'black', backgroundImage: `url(${spaceTorchImage})`, backgroundSize: 'cover' }}>
        <h1 className="eventName welcometag">Quizaholic</h1>
        <p className="eventDesc" style={{ textAlign: "center", marginTop: '20px', color: '#E4A732' }}>
          ...
          This is a non-technical fun quiz. Try to put your complete thinking capability to be a master quizzer. It isn't about WHAT you think, but HOW you think.
        </p>
          ...
          <Row>
            <Col md={6}>
              <div className="banner">
                <img src={mismatchimg} alt="snapShots1" className="img-fluid rounded shadow-lg mx-auto d-block" />
              </div>
              ...
              <div className="details text-center">
                ...
                <p className="detailsTxt custom-text-color">Hall No: 314</p>
              </div>
            </Col>
            <Col md={6}>
              <h1 className="heads custom-text-color">RULES</h1>
              <ul className="points custom-text-color">
                <li>It is to be played in teams, i.e., only two members in one team</li>
              ...
              <ul className="points custom-text-color">
                <li>1st round: MCQ based general quiz (elimination round)</li>
                <li>2nd round: Finding songs (elimination round)</li>
                <li>3rd round: Finding movies from pictures (connection and memory testing)</li>
              </ul>

              <h1 className="heads custom-text-color">Staff Coordinators</h1>
              <ul className="points custom-text-color">
                <li>Dr G KIRUBASRI</li>
                <li>Ms S POURNIMA</li>
              </ul>

              <h1 className="heads custom-text-color">Coordinators</h1>
              <ul className="points custom-text-color">
                <li>Vigneashwaran B: 9361320665</li>
                <li>Varuna Priya: 8925798585</li>
              </ul>
            </Col>
          </Row>
        </div>
